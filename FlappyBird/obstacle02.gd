...
func position_obstacle(opening_height):
	...
	var top_obstacle_position = Vector2(obstacle_width/2,top_obstacle_bottom_edge_y - top_obstacle_size.y/2)
	...
	$Top/TopSprite.set_scale(top_scale_to_apply)
#	$Top/TopSprite.set_region_rect(Rect2(Vector2(0,top_obstacle_position),Vector2(obstacle_width,top_obstacle_size_y)))
	...
	var bot_obstacle_position = Vector2(obstacle_width/2,bot_obstacle_top_edge_y + bot_obstacle_size.y/2)
	...
	$Bottom/BottomSprite.set_scale(bot_scale_to_apply)
